            ...
            <div class="max-w-3xl mx-auto">
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Perbarui detail untuk: {{ $alat->nama_alat }}</p>
                    </div>

                    <hr class="my-6 border-gray-200">

                    <form action="{{ route('admin.alat.update', $alat->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:ring-2 focus:ring-blue-500 @error('status') border-red-500 @enderror" required>
                                ...
                                <option value="Sedang Digunakan" {{ old('status', $alat->status) == 'Sedang Digunakan' ? 'selected' : '' }}>Sedang Digunakan</option>
